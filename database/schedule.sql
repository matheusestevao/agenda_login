...
--
-- Host: 127.0.0.1
-- Generation Time: 26-Nov-2018 às 21:10
...
(2616506, 'Xexéu', 26),
(2700102, 'Água Branca', 26),
(2700201, 'Anadia', 26),
(2700300, 'Arapiraca', 26),
(2700409, 'Atalaia', 26),
(2700508, 'Barra de Santo Antônio', 26),
(2700607, 'Barra de São Miguel', 26),
(2700706, 'Batalha', 26),
(2700805, 'Belém', 26),
(2700904, 'Belo Monte', 26),
(2701001, 'Boca da Mata', 26),
(2701100, 'Branquinha', 26),
(2701209, 'Cacimbinhas', 26),
(2701308, 'Cajueiro', 26),
(2701357, 'Campestre', 26),
(2701407, 'Campo Alegre', 26),
(2701506, 'Campo Grande', 26),
(2701605, 'Canapi', 26),
(2701704, 'Capela', 26),
(2701803, 'Carneiros', 26),
(2701902, 'Chã Preta', 26),
(2702009, 'Coité do Nóia', 26),
(2702108, 'Colônia Leopoldina', 26),
(2702207, 'Coqueiro Seco', 26),
(2702306, 'Coruripe', 26),
(2702355, 'Craíbas', 26),
(2702405, 'Delmiro Gouveia', 26),
(2702504, 'Dois Riachos', 26),
(2702553, 'Estrela de Alagoas', 26),
(2702603, 'Feira Grande', 26),
(2702702, 'Feliz Deserto', 26),
(2702801, 'Flexeiras', 26),
(2702900, 'Girau do Ponciano', 26),
(2703007, 'Ibateguara', 26),
(2703106, 'Igaci', 26),
(2703205, 'Igreja Nova', 26),
(2703304, 'Inhapi', 26),
(2703403, 'Jacaré dos Homens', 26),
(2703502, 'Jacuípe', 26),
(2703601, 'Japaratinga', 26),
(2703700, 'Jaramataia', 26),
(2703759, 'Jequiá da Praia', 26),
(2703809, 'Joaquim Gomes', 26),
(2703908, 'Jundiá', 26),
(2704005, 'Junqueiro', 26),
(2704104, 'Lagoa da Canoa', 26),
(2704203, 'Limoeiro de Anadia', 26),
(2704302, 'Maceió', 26),
(2704401, 'Major Isidoro', 26),
(2704500, 'Maragogi', 26),
(2704609, 'Maravilha', 26),
(2704708, 'Marechal Deodoro', 26),
(2704807, 'Maribondo', 26),
(2704906, 'Mar Vermelho', 26),
(2705002, 'Mata Grande', 26),
(2705101, 'Matriz de Camaragibe', 26),
(2705200, 'Messias', 26),
(2705309, 'Minador do Negrão', 26),
(2705408, 'Monteirópolis', 26),
(2705507, 'Murici', 26),
(2705606, 'Novo Lino', 26),
(2705705, 'Olho D\'Água das Flores', 26),
(2705804, 'Olho D\'Água do Casado', 26),
(2705903, 'Olho D\'Água Grande', 26),
(2706000, 'Olivença', 26),
(2706109, 'Ouro Branco', 26),
(2706208, 'Palestina', 26),
(2706307, 'Palmeira dos Índios', 26),
(2706406, 'Pão de Açúcar', 26),
(2706422, 'Pariconha', 26),
(2706448, 'Paripueira', 26),
(2706505, 'Passo de Camaragibe', 26),
(2706604, 'Paulo Jacinto', 26),
(2706703, 'Penedo', 26),
(2706802, 'Piaçabuçu', 26),
(2706901, 'Pilar', 26),
(2707008, 'Pindoba', 26),
(2707107, 'Piranhas', 26);
INSERT INTO `cidade` (`id`, `nome`, `id_estado`) VALUES
(2707206, 'Poço das Trincheiras', 26),
(2707305, 'Porto Calvo', 26),
(2707404, 'Porto de Pedras', 26),
(2707503, 'Porto Real do Colégio', 26),
(2707602, 'Quebrangulo', 26),
(2707701, 'Rio Largo', 26),
(2707800, 'Roteiro', 26),
(2707909, 'Santa Luzia do Norte', 26),
(2708006, 'Santana do Ipanema', 26),
(2708105, 'Santana do Mundaú', 26),
(2708204, 'São Brás', 26),
(2708303, 'São José da Laje', 26),
(2708402, 'São José da Tapera', 26),
(2708501, 'São Luís do Quitunde', 26),
(2708600, 'São Miguel dos Campos', 26),
(2708709, 'São Miguel dos Milagres', 26),
(2708808, 'São Sebastião', 26),
(2708907, 'Satuba', 26),
(2708956, 'Senador Rui Palmeira', 26),
(2709004, 'Tanque D\'Arca', 26),
(2709103, 'Taquarana', 26),
(2709152, 'Teotônio Vilela', 26),
(2709202, 'Traipu', 26),
(2709301, 'União dos Palmares', 26),
(2709400, 'Viçosa', 26),
...
INSERT INTO `pessoa` (`id`, `id_perfil`, `nome`, `email`, `senha`, `sexo`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `estado`, `session_id`, `permissoes`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES
(1, 2, 'admin', 'admin@admin.com', '$2a$08$Pz6FsnMM9iaxH.q7tyBYwe8SYtf.8xtLWopCQsR3fz51U6Nvw.88C', NULL, NULL, NULL, NULL, NULL, NULL, '1300102', '13', 'mn8iqedkb8jc6h7doe5kdosmi6', '', NULL, '2018-11-25 23:27:53', NULL, NULL);
...
ALTER TABLE `pessoa`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pessoa_perfil_idx` (`id_perfil`);

--
-- Indexes for table `telefone_contato`
--
ALTER TABLE `telefone_contato`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_telefone_contato_tipo_contato1_idx` (`id_tipo_contato`),
  ADD KEY `fk_telefone_contato_pessoa1_idx` (`id_pessoa`);
...
--
-- AUTO_INCREMENT for table `telefone_contato`
--
ALTER TABLE `telefone_contato`
...
--
ALTER TABLE `pessoa`
  ADD CONSTRAINT `fk_pessoa_perfil` FOREIGN KEY (`id_perfil`) REFERENCES `perfil` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `telefone_contato`
--
ALTER TABLE `telefone_contato`
  ADD CONSTRAINT `fk_telefone_contato_pessoa1` FOREIGN KEY (`id_pessoa`) REFERENCES `pessoa` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_telefone_contato_tipo_contato1` FOREIGN KEY (`id_tipo_contato`) REFERENCES `tipo_contato` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
